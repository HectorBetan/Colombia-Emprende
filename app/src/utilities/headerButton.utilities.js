...
const ResolvePhoto = () => {
    ...
    return (
        <div>
            ...
            className="me-1" src={user.photoURL} alt=""/>
        </div>
    );}
    else{
    return (
        <div>
            <i className="fa-solid fa-circle-user fa-3x me-1"></i>
        </div>
    );}
};
export const UserButton = () => {
    ...
    return (
        <div>
          <Dropdown>
            <Dropdown.Toggle variant="success" id="dropdown-basic" className="text-end d-flex flex-row align-middle align-items-center">
