...
export const LoginButton = () => {
        ...
        <div className="d-flex flex-row justify-content-evenly pb-3">
          ...
          >
            <button
              ...
              style={{
                width: "150px",
                border: "1.5px solid rgb(0 , 175 ,  255)",
                borderRadius: "10px",
              }}
              type="submit"
            >
  ...
  return (
    <div className="me-3">
      <Nav.Link
        className="justify-content-end m-lg-0 m-md-0 me-sm-5 me-5 text-end d-flex flex-row align-middle align-items-center"
        role="button"
        onClick={handleShow}
      >
...
export const LoginButtonNav = () => {
      ...
      <Modal show={show} onHide={handleClose} backdrop="static">
        ...
        <div className="d-flex flex-row justify-content-evenly pb-3">
          <form
            onSubmit={(e) => {
              e.preventDefault();
              handleGoogleSignin(loginWithGoogleRedirect);
            }}
          >
            <button
              className="d-flex flex-row m-3 p-2 justify-content-center"
  ...
  return (
    <div>
      <Nav.Link
        className="pt-3 pb-2  d-flex flex-row"
        role="button"
        onClick={handleShow}
      >
      ...
      <Nav.Link
        className="pt-3 mt-1 pb-2 d-flex flex-row "
        role="button"
        onClick={(e) => {
          e.preventDefault();
          setKey("singup");
  ...
  return (
    <div className=" text-center">
      <div className="tarjeta-registro-footer text-center">
        <a
          href="*"
          className="publi-registro text-center"
          onClick={(e) => {
            e.preventDefault();
            setKey("singup");
            handleShow();
...
export const ModalCarrito = () => {
  const [key, setKey] = useState("login");
  const { showLoginFalse, alertLogin, alertLoginFalse } = useAuth();
  const handleClose = () => {showLoginFalse()};
  const { loginWithGoogleRedirect } = useAuth();
  if(alertLogin){
    setTimeout(() => {
      alertLoginFalse()
  ...
  const ModalLogin = () => {
    return (
      <Modal show={true} onHide={handleClose} backdrop="static">
        <Modal.Header closeButton />
        {alertLogin && <div
        className="text-center border border-red-400 p-2 rounded bg-light ms-2 me-2 ms-sm-4 me-sm-4 m-2"
        role="alert"
        id="alerta"
      >
          <span className="sm:inline block text-danger fw-bold">Debes Iniciar Sesión o Registrarte para añadir productos al Carrito.</span>
        </div>}
        <Tabs
          justify
          id="login-tab"
...
<svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
              ...
              to="/reverificacion"
              className="navi-link ms-2 align-middle"
            >
              Verificar mi Cuenta
            </Link>
          </Dropdown.Item>
          ...
          {user && userData && userData.Emprendimiento_id && (
            <Dropdown.Item as="button" className="drop-menu-item">
              ...
              <Link
                ...
                className="navi-link ms-2 align-middle "
                style={activar("/admin/mi-emprendimiento")}
              >
                Mi Emprendimiento
              </Link>
            </Dropdown.Item>
          ...
          >
            ...
            <span className="navi-link  ms-2 align-middle ">Cerrar Sesión</span>
          </Dropdown.Item>
        </Dropdown.Menu>
      </Dropdown>
    </div>
