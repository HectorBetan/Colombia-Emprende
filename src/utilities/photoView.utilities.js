...
export const StoreLogo = (size) => {
    return (
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" width={size.w} height={size.h} fill="currentColor" className="bi bi-shop" viewBox="0 0 16 16">
...
export const ProductLogo = (size) => {
    return (
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" width={size.w} height={size.h} fill="currentColor" className="bi bi-archive-fill" viewBox="0 0 16 16">
