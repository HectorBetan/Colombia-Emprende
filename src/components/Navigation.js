...
function NavigationBar() {
  ...
  const Return = () => {
    if (location.pathname !== "/") {
      return (
        <div
          className="text-white d-lg-none d-xl-none d-xxl-none retorno"
          onClick={(e) => {
            e.preventDefault();
            try {
              navigate(-1);
    ...
    return (
      <div className="accordion accordion-flush pt-2" id="#acordionMenu">
        <div className="accordion-item">
          ...
          <h6
          className="cel-menu-user"
          role="button"
          onClick={(e) => {
            e.preventDefault();
            navigate("/reverificacion");
            handleClose();
          }}
        >
...
<div
                  to="/reverificacion"
                  className=" ms-2 align-middle nav-cel-links"
                >
                  Verificar Cuenta
                </div>
          </h6>
              ...
              >
                ...
                <span className="ms-2 align-middle  nav-cel-links">
                  Cerrar Sesión
                </span>
              </h6>
            </div>
    ...
    <div>
      <nav className="navbar navbar-dark bg-dark justify-content-evenly">
        <div className="d-none d-md-block d-lg-block d-xl-block d-xxl-block">
          <ul className="navbar-nav me-auto d-flex flex-row">
            <li className="nav-item ms-4">
              <Link
                to={"/"}
                className="nav-link me-4 ms-4 navi-big"
                style={activar("/")}
              >
                Inicio
              </Link>
            ...
            <li className="nav-item">
              <Link
                to={"/Emprendimientos"}
                style={activar("/Emprendimientos")}
                className="nav-link ms-4 me-4 navi-big"
              >
                Emprendimientos
              </Link>
            </li>
        ...
        <div className="container d-md-none d-lg-none d-xl-none d-xxl-none">
          <Return />
          <span className="navbar-brand mb-0 d-md-none d-lg-none d-xl-none d-xxl-none">
            <img
              src={Logo}
              alt="Logo"
              style={{ maxWidth: "220px" }}
              className="logo-nav-home"
            />
          </span>
          ...
          >
            <Offcanvas.Header closeButton>
              <Offcanvas.Title>
                <img src={LogoNav} alt="" className="logo-navcel" />
              </Offcanvas.Title>
            </Offcanvas.Header>
            <Offcanvas.Body>
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li className="nav-item pt-2 pb-2">
                  <div
                    role="button"
                    style={activar("/")}
                    className="nav-link me-3 ms-2 nav-cel"
                    onClick={(e) => {
                      e.preventDefault();
                      navigate("/");
                      handleClose();
                ...
                <li className="nav-item pt-2 pb-2">
                  <div
                    role="button"
                    style={activar("/emprendimientos")}
                    className="nav-link ms-2 me-4 nav-cel"
                    onClick={(e) => {
                      e.preventDefault();
