...
function MyStoreNav() {
    ...
    const activar = (ruta) =>{
        ...
        if (routePath && routePath.pathname === ruta){
            return({
            ...
            <div>{userData &&
                    <div>
                        ...
                        navigate("/admin")}}>
                            ...
                            <div className="nav-link  d-none d-md-block  d-lg-block d-xl-block d-xxl-block">Ir a Mi Perfil</div>
                            </li>
                    </div>}
            </div>)
        }
        ...
        return(<>
            <Offcanvas show={show} onHide={handleClose} className="admin-nav-cel bg-dark">
                ...
                <nav className="nav nav-pills navbar-dark bg-dark flex-column w-100">
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        navigate("/admin/mi-emprendimiento"); handleClose()}} style={activar("/admin/mi-emprendimiento")}>
                    ...
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        navigate("/admin/mi-emprendimiento/productos"); handleClose()}} style={activar("/admin/mi-emprendimiento/productos")}>
                        
                        <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-archive-fill" viewBox="0 0 16 16">
                <path d="M12.643 15C13.979 15 15 13.845 15 12.5V5H1v7.5C1 13.845 2.021 15 3.357 15h9.286zM5.5 7h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1zM.8 1a.8.8 0 0 0-.8.8V3a.8.8 0 0 0 .8.8h14.4A.8.8 0 0 0 16 3V1.8a.8.8 0 0 0-.8-.8H.8z"/>
            </svg>
                        <div className="nav-link">Mis Productos</div>
                    </li>
                    
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        navigate("/admin/mi-emprendimiento/cotizaciones"); handleClose()}} style={activar("/admin/mi-emprendimiento/cotizaciones")}>
                        ...
                        <div className="nav-link">Cotizaciones</div>
                    </li>
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        navigate("/admin/mi-emprendimiento/pedidos"); handleClose()}} style={activar("/admin/mi-emprendimiento/pedidos")}>
            ...
            <nav className="navbar navbar-dark bg-dark flex-column admin-nav pt-2 pb-3" id="adminNav">
                <nav className="nav nav-pills navbar-dark bg-dark flex-column w-100">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-shop" viewBox="0 0 16 16">
                        ...
                        <div className="nav-link d-none d-md-block  d-lg-block d-xl-block d-xxl-block">Mi Emprendimiento</div>
                    </li>
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                ...
                <path d="M12.643 15C13.979 15 15 13.845 15 12.5V5H1v7.5C1 13.845 2.021 15 3.357 15h9.286zM5.5 7h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1zM.8 1a.8.8 0 0 0-.8.8V3a.8.8 0 0 0 .8.8h14.4A.8.8 0 0 0 16 3V1.8a.8.8 0 0 0-.8-.8H.8z"/>
                        ...
                        <div className="nav-link  d-none d-md-block  d-lg-block d-xl-block d-xxl-block">Mis Productos</div>
                    </li>
                    ...
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        ...
                        <div className="nav-link  d-none d-md-block  d-lg-block d-xl-block d-xxl-block">Cotizaciones</div>
                    </li>
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        ...
                        <div className="nav-link  d-none d-md-block  d-lg-block d-xl-block d-xxl-block">Pedidos</div>
                    </li>
                    <NavUser />
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        handleLogout()}}>
