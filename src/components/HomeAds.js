      ...
      <div>
        <div className="d-flex flex-row justify-content-center p-2 modulo-emprendedores-responsive">
          <div className="me-xl-5 me-lg-3 me-md-3 me-0 me-xxl-5">
            <div className="tarjeta-registro-1 card">
              ...
              <div className="tarjeta-emprendedor-oculta-1 card-img-overlay">
                En Colombia Emprende
                <br />
                <p>
                  te ofrecemos un espacio donde puedes conectar con
                  emprendedores y registrar tu emprendimiento.{" "}
                </p>
              </div>
            </div>
          ...
          <div className="seccion-noticias card col-3 p-3 d-none d-lg-block d-xl-block d-xxl-block">
            <img
              src={ley}
              className="imagen-seccion-noticias card-img-top"
              alt="..."
            />
            <div className="card-body">
              <h5 className="card-title">Noticias</h5>
              <p className="card-text">
                Conoce la nueva <b>Ley de Emprendimiento 2020</b> creada para
                ayudar a los emprendedores colombianos.
              </p>
            </div>
            <div className="card-footer text-center">
              <a
                href="https://dapre.presidencia.gov.co/normativa/normativa/LEY%202069%20DEL%2031%20DE%20DICIEMBRE%20DE%202020.pdf"
                target="_blank"
                rel="noreferrer"
              >
                Ver Documento
          ...
          <div className="me-xl-5 me-lg-3 me-md-3 me-0 me-xxl-5">
            <div className="tarjeta-registro-2 card">
              ...
              <div className="tarjeta-emprendedor-oculta-2 card-img-overlay">
                ...
                <br />
                <p>
                  En Colombia Emprende te ofrecemos un espacio donde puedes
                  crear el perfil de tu Emprendimiento.{" "}
                </p>
              </div>
            </div>
          ...
          <div className="me-xl-5 me-lg-3 me-md-3 me-0 me-xxl-5">
            <div className="tarjeta-registro card">
              ...
              <div className="tarjeta-emprendedor-oculta card-img-overlay">
                En Colombia Emprende
                <p>
                  estamos felices de que pertenezcas a nuestra familia, daremos
                  lo mejor por seguirte apoyando
                </p>
              </div>
            </div>
