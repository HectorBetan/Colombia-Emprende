                    ...
                    <div key={i} className="stores-home">
                      <div className="card">
                        <div className="card-body">
                          {!nombre && (
                            <h5 className="card-title">{store.Nombre}</h5>
                          )}
                          {nombre && <h5 className="card-title">{nombre}</h5>}
                          <div className="d-flex  justify-content-evenly">
                            <div className="">
                              <img
                                src={img}
                            ...
                            <div className="m-lg-2 m-xl-2 m-xxl-2 m-md-2 m-1">
                              <span className="stores-home-text d-flex">
                                <p>Ciudad:</p>
                                <h5 className=" text-start">{store.Ciudad}</h5>
                              </span>
                              <span className="stores-home-text d-flex">
                                <p>Celular:</p>
                                <h5 className=" text-start">{store.Celular}</h5>
                              </span>
