        ...
        <div className="d-lg-flex d-xl-flex d-xxl-flex d-md-flex d-sm-flex d-block flex-row text-center justify-content-evenly">
          <div className="m-2 p-md-3 p-xl-3 p-xxl-3 p-lg-3 d-none d-md-block d-lg-block d-xl-block d-xxl-block">
            ...
            <span className="d-lg-flex d-xl-flex d-xxl-flex d-md-flex ">
              <a href="/acerca-de" target="_blank">
                <img className="logo-footer-acerca" src={logoColombia} alt="" />
              </a>
              <a
                target="_blank"
                ...
                rel="noreferrer"
              >
                <img className="logo-footer-acerca" src={hector} alt="" />
              </a>
            </span>
          </div>
          <div className="m-2 p-md-3 p-xl-3 p-xxl-3 p-lg-3 mb-4">
            ...
            <div className="d-lg-flex d-xl-flex d-xxl-flex d-md-flex flex-row">
              <a
                href="https://www.facebook.com/Colombia-Emprende-109565371475068"
                rel="noreferrer"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="iconos-footer bi bi-facebook"
                  viewBox="0 0 16 16"
                >
              ...
              <a
                href="https://www.instagram.com/colombiaemprende5/"
                rel="noreferrer"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="iconos-footer bi bi-instagram"
                  viewBox="0 0 16 16"
                >
              ...
              <a
                href="https://twitter.com/ColombiaEmpren5"
                rel="noreferrer"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="iconos-footer bi bi-twitter"
                  viewBox="0 0 16 16"
                >
              ...
              <a
                href="https://www.youtube.com/channel/UCjNR0g-WdYRHMZZBRtl5JUA"
                rel="noreferrer"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="iconos-footer bi bi-youtube"
                  viewBox="0 0 16 16"
                >
          ...
          <div className=" m-2 p-md-3 p-xl-3 p-xxl-3 p-lg-3 d-none d-lg-block d-xl-block d-xxl-block">
            ...
            <span className="d-md-flex d-lg-flex d-xl-flex d-xxl-flex d-md-flex">
              <a
                ...
                rel="noreferrer"
              >
                <img className="logos-footer" src={utp} alt="" />
              </a>
              <a
                href="https://mintic.gov.co/portal/inicio/"
                rel="noreferrer"
                target="_blank"
              >
                <img className="logos-footer" src={mintic} alt="" />
              </a>
            </span>
          </div>
