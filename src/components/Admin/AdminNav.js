    ...
    const NavEmprendimiento = () => {  
        if (userData){ return(
            <div>{userData.Emprendimiento_id &&
                    <div>
                        <li className="nav-item  d-flex flex-row" role="button">
                            ...
                            <Link className="nav-link d-none d-md-block d-lg-block d-xl-block d-xxl-block" to={"/admin/mi-emprendimiento"}>Mi emprendimiento</Link>
                            </li>
                    </div>}
            </div>)
        }
        ...
        <div className="navegacion-admin" >
            <nav className="navbar navbar-dark bg-dark flex-column admin-nav pt-2 pb-3" id="adminNav">
                <nav className="nav nav-pills navbar-dark bg-dark flex-column w-100">
                    <li className="nav-item d-flex flex-row d-md-none d-lg-none d-xl-none d-xxl-none" role="button">
