            ...
            <div>{userData.Emprendimiento_id &&
                    <div>
                        ...
                        navigate("/admin/mi-emprendimiento")}} >
                            ...
                            <Link className="nav-link" to={"/admin/mi-emprendimiento"}>Mi emprendimiento</Link>
                            </li>
                    </div>}
            </div>)
        }
            ...
            <div>{userData.Emprendimiento_id &&
                    <div>
                        ...
                        navigate("/admin/mi-emprendimiento")}} >
                            ...
                            <Link className="nav-link d-md-block  d-none d-lg-block d-xl-bloxk d-xxl-block" to={"/admin/mi-emprendimiento"}>Mi emprendimiento</Link>
                            </li>
                    </div>}
            </div>)
        }
    ...
    const OffNav = () =>{
        return(<>
            <Offcanvas show={show} onHide={handleClose} className=" admin-nav-cel bg-dark ">
                <Offcanvas.Header>
                <Offcanvas.Title className="text-white">Mi Perfil</Offcanvas.Title>
                ...
                <nav className="nav nav-pills navbar-dark bg-dark flex-column w-100">
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        navigate("/admin")}} style={activar("/admin")}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-person-circle" viewBox="0 0 16 16">
                            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                            <path fillRule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
                        </svg>
                        <Link className="nav-link" aria-current="page" to={"/admin"}>Mi Perfil</Link>
                    </li>
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        navigate("/admin/mi-carrito")}} style={activar("/admin/mi-carrito")}>
                        ...
                        <Link className="nav-link" to={"/admin/mi-carrito"}>Mi Carrito</Link>
                    </li>
                    
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        navigate("/admin/mis-cotizaciones")}} style={activar("/admin/mis-cotizaciones")}>
                        ...
                        <Link className="nav-link" to={"/admin/mis-cotizaciones"}>Mis Cotizaciones</Link>
                    </li>
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        navigate("/admin/mis-pedidos")}} style={activar("/admin/mis-pedidos")}>
                        ...
                        <Link className="nav-link" to={"/admin/mis-pedidos"}>Mis Pedidos</Link>
                    </li>
            ...
            <nav className="navbar navbar-dark bg-dark flex-column admin-nav pt-2 pb-3" id="adminNav">
                <nav className="nav nav-pills navbar-dark bg-dark flex-column w-100">
                    ...
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        ...
                        <Link className="nav-link d-md-block d-none d-lg-block d-xl-block d-xxl-block" aria-current="page" to={"/admin"}>Mi Perfil</Link>
                    </li>
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        navigate("/admin/mi-carrito")}} style={activar("/admin/mi-carrito")}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-cart4" viewBox="0 0 16 16">
                        ...
                        <Link className="nav-link d-none d-md-block  d-lg-block d-xl-block d-xxl-block" to={"/admin/mi-carrito"}>Mi Carrito</Link>
                    </li>
                    ...
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        ...
                        <Link className="nav-link d-md-block  d-none d-lg-block d-xl-block d-xxl-block" to={"/admin/mis-cotizaciones"}>Mis Cotizaciones</Link>
                    </li>
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        navigate("/admin/mis-pedidos")}} style={activar("/admin/mis-pedidos")}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-truck" viewBox="0 0 16 16">
                        ...
                        <Link className="nav-link d-md-block  d-none d-lg-block d-xl-bloxk d-xxl-block" to={"/admin/mis-pedidos"}>Mis Pedidos</Link>
                    </li>
                    <NavEmprendimiento />
                    <li className="nav-item d-flex flex-row" role="button" onClick={(e)=>{e.preventDefault();
                        handleLogout()}}>
