...
function MyCart() {
  ...
  const handleCotizar = async (tienda, tkey, store) => {
    if (!checked1 && !checked2 && store.Recoger) {
      sAlertEnvio();
    ...
    let dir;
    let env;
    if (checked2 || !store.Recoger) {
      env = true;
      ciudad = document.getElementById(`ciudad${tienda.Tienda}`).value;
      dir = document.getElementById(`direccion${tienda.Tienda}`).value;
    }
    if (checked1) {
      env = false;
      ciudad = "";
  ...
  const sendCotizacion = async (cotizacion, lista, store) => {
    ...
    let mail = {
      ...
      <div>Tienes una nueva solicitud de cotización en Colombia Emprende.<br /> 
  ...
  const changeEnvio1 = (id) => {
    setRequired(false);
    setChecked1(true);
    setChecked2(false);
  };
  const changeEnvio2 = (id) => {
    setRequired(false);
    setChecked2(true);
    setChecked1(false);
  };
      ...
      if (miCarrito.length > 0 && tiendas) {
                      ...
                      <div className="accordion-body pt-0">
                        ...
                        >
                          <div className="text-start mt-3 mb-3">
                            ...
                            {store.Recoger && <div>
                              <div className="m-sm-4 m-2 text-center fs-4 fw-bold mb-0 recibir-pedido">
                                ¿Como deseas recibir tu pedido?
                              </div>
                              <div className="mb-4 d-flex flex-row justify-content-evenly carrito-checks">
                                <div className="form-check me-md-4 ms-md-4 fs-3 m-1 mt-3 mb-3 form-check-carrito">
                                  <input
                                    className="form-check-input ch-in"
                                    type="checkbox"
                                    id={`flexRadio1${tienda.Tienda}`}
                                    checked={checked1}
                                    onClick={(e) => {
                                      e.preventDefault();
                                      changeEnvio1(tienda.Tienda);
                                    }}
                                    onChange={(e) => {
                                      e.preventDefault();
                                    }}
                                  ...
                                  <label
                                    ...
                                    htmlFor={`flexRadio1${tienda.Tienda}`}
                                  >
                                    Recoger en Tienda
                                  </label>
                                </div>
                                <div className="form-check me-md-4 ms-md-4 fs-3 m-1 mt-3 mb-3 form-check-carrito">
                                  <input
                                    className="form-check-input ch-in"
                                    type="checkbox"
                                    id={`flexRadio2${tienda.Tienda}`}
                                    checked={checked2}
                                    onClick={(e) => {
                                      e.preventDefault();
                                      changeEnvio2(tienda.Tienda);
                                    }}
                                    onChange={(e) => {
                                      e.preventDefault();
                                    }}
                                  ...
                                  <label
                                    className="form-check-label"
                                    htmlFor={`flexRadio2${tienda.Tienda}`}
                                  >
                            ...
                            {required && (
                              <div
                                className="text-center border border-red-400 p-2 rounded bg-light ms-1 me-1 ms-sm-4 me-sm-5 mb-4"
                                role="alert"
                                id="alerta"
                              >
                                <i className="fa-solid fa-circle-xmark me-1 text-danger"></i>
                                <span className="sm:inline block text-danger">
                                  Por favor selecciona la forma en que vas a
                                  recibir tu pedido
                                </span>
                              </div>
                            )}
                            {(checked2 || !store.Recoger) && (
                              <div className="mt-4 datos-envio">
                                <h2 className="text-center titulo">Datos de Envio
                                
                                </h2>
                                <h6>¿Donde deseas recibir tu pedido?</h6>
                                
                                <div className="d-flex m-1 me-md-4 ms-md-4 city-select-box  mt-3 mb-3">
                                  <label>
        ...
        return (
          <div className="text-center m-3">
            ...
            {alertDel && <AlertDelete />}
            <h3>
              No tienes ningun producto en{" "}
              <span className="admin-dif-color">tu carrito</span>.
            </h3>
          </div>
        );
      }
